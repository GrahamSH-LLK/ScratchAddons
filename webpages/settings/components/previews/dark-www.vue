...
const colors = computed(() => ({
  pageText: textColor(props.settings.page),
  navbarText: textColor(props.settings.navbar),
  navbarBorder: textColor(props.settings.navbar, "rgba(0, 0, 0, 0.1)", "rgba(255, 255, 255, 0.1)", 60),
  inputText: textColor(props.settings.input),
  footerText: textColor(props.settings.footer),
  greenBox: {
    off: "#328554",
    darker: "#064734",
    desaturated: "#27473e",
  }[props.settings.darkBanners],
}));
</script>
